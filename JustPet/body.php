  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner3.jpg" alt="justpets" style="width:100%;">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Pet Accessories and Food</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="hot-deal">
              ...
              <h2 class="text-uppercase">Explore Pets</h2>
              <p>New Collection Up to 50% OFF</p>
              <a class="primary-btn cta-btn" href="exploredogs.php">Dogs</a>
              <a class="primary-btn cta-btn" href="explorecats.php">Cats</a>
            </div>
          </div>
        </div>
        <!-- /row -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="hot-deal">
              ...
              <h2 class="text-uppercase">Pet care</h2>
              <p>New Collection Up to 50% OFF</p>
              <a class="primary-btn cta-btn" href="doctorinfo.php">Shop now</a>
            </div>
          </div>
        </div>
        <!-- /row -->
